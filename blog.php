                ...
                <?php foreach ($result as $blog): ?>
                    <div class="blog-card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="blog_toggle_fav.php?blog_id=<?= $blog['blog_id'] ?>" class="btn-fav" style="font-size:20px;">
                                <?php if ($isFav): ?>
