...
<body>
    <div class="main-content">
        <div class="form-container">
            ...
            <form action="blog_addprocess.php" method="POST" enctype="multipart/form-data">
                <div class="form-content">
                    ...
                    <div class="form-fields">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="content" name="content_blog" placeholder="Here is where you type your blog contents" required></textarea>
                        </div>
                    </div>
